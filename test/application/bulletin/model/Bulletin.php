...
class Bulletin extends Model {
    ...
    public function getPrevAttr($value,$data){
        ...
        return $res[$data['id']] = \app\bulletin\model\Bulletin::where($where) -> field(true) -> find()?:[];
    }
    // 获取下一篇
    public function getNextAttr($value,$data){
        ...
        return $res[$data['id']] = \app\bulletin\model\Bulletin::where($where) -> field(true) -> order('id desc') -> find()?:[];
    }
}